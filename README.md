...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-paws.management-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14239&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-paws.management-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-paws.management` can be installed with:

```
conda install r-paws.management
```

It is possible to list all of the versions of `r-paws.management` available on your platform with:
